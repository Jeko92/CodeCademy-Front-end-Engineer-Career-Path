# Intructions to use app

## To use App create ./src/util/SpotifyApi.js file and inside create and export two constants: clientId(with spotify's client ID) `const clientId = "";` and `const redirectUri = "http://localhost:3000"`
...
- [Intructions to use app](#intructions-to-use-app)
  - [To use App create ./src/util/SpotifyApi.js file and inside create and export two constants: clientId(with spotify's client ID) `const clientId = "";` and `const redirectUri = "http://localhost:3000"`](#to-use-app-create-srcutilspotifyapijs-file-and-inside-create-and-export-two-constants-clientidwith-spotifys-client-id-const-clientid---and-const-redirecturi--httplocalhost3000)
